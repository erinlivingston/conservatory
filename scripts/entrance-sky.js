/**
 * Full-viewport p5 sky for the entrance page — same gradient + drifting clouds as desert/aquatic,
 * driven by the shared day-cycle in sky-cycle.js and sky-gradient-clouds.js.
 */
(function initEntranceSky() {
  const skyRoot = document.getElementById("entrance-sky-bg");
  ...
  // Preset keys and layer shapes match biome rooms so blends stay consistent.
  const skyPresets = {
    brightDay: {
